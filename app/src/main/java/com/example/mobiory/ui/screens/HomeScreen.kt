...
@Composable
fun HomeScreen(setHomeNotifications: (Boolean) -> Unit) {
    ...
    LazyColumn(
        ...
        item {
            EventOfTheDay(notificationPermissions, setHomeNotifications)
        }
        item {
...
@Composable
fun EventOfTheDay(notificationPermissions: Boolean, setHomeNotifications: (Boolean) -> Unit) {
